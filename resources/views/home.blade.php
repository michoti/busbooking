        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Book a <span class="text-primary">room</span> now</h1>
                </div>
                <div class="row g-4">
            ...
            <div class="container pb-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Nairobi</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+254 725 67890</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            ...
                            Designed By <a class="border-bottom" href="">Michoti</a>
                        </div>
